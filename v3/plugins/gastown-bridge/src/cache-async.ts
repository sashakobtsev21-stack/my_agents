/**
 * GasTown Bridge — async/concurrency utilities
 *
 * BatchDeduplicator, ModulePreloader, ResourcePool, DebouncedEmitter,
 * and Lazy/AsyncLazy. Extracted verbatim from cache.ts (lines 454-1081)
 * during the P3.75 god-file decomposition (W196). cache.ts stays the
 * barrel.
 */
