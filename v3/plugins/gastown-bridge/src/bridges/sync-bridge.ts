...
// Caches/schemas/types/error extracted into ./sync-bridge-defs.ts during
// campaign-2 wave 12 (W218). Re-export the original public surface; the
// caches, schemas and default logger stay module-private.
export { SyncBridgeError } from './sync-bridge-defs.js';
export type {
  ConflictStrategy,
  SyncDirection,
  SyncStatus,
