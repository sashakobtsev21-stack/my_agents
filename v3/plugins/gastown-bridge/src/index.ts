...
// The plugin-system/bridge interfaces, config, GUPP stub, logger, and
// WasmLoaderAdapter were extracted into ./plugin-host.ts during the
// P3.70 god-file decomposition (W191, cut #1). Re-export the public
// types; import back the private implementations the class uses.
export type {
  PluginContext,
  PluginMCPTool,
  HookPriority,
...
import type { PluginLogger } from './plugin-host.js';
import type {
  PluginContext,
  PluginMCPTool,
  PluginHook,
