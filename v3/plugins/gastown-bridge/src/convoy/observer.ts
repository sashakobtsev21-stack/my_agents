...
// The types, default logger, and validation schema were extracted into
// ./observer-types.ts during the P3.74 god-file decomposition (W195,
// cut #1). Re-export the public types; the private pieces are imported
// back without re-export. The ConvoyObserver class (~875 LOC) remains
// the cohesive core of this file.
export type {
  WasmGraphModule,
  CompletionCallback,
  WatchHandle,
  ConvoyObserverConfig,
  BlockerInfo,
  ReadyIssueInfo,
