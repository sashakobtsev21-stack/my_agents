...
export async function handleTrajectoryBegin(
...
export async function handleTrajectoryStep(
...
export async function handleTrajectoryContext(
...
export async function handleTrajectoryEnd(
...
export async function handlePatternFind(
...
export async function handleMicroLoraApply(
...
export async function handleBaseLoraApply(
  input: z.infer<typeof loraApplySchema>,
  context?: ToolContext
): Promise<{
  adapted: boolean;
...
export async function handleForceLearn(
