...
import { createTrajectory, generateSimpleEmbedding, inferAgentFromTask, } from './hooks-tools-support.js';
// ============================================================================
 ...
 */
export async function getReasoningBank() {
 ...
 */
export async function handlePreEdit(input, context) {
 ...
 */
export async function handlePostEdit(input, context) {
    const reasoningBank = await getReasoningBank();
 ...
 */
export async function handlePreCommand(input, context) {
    const reasoningBank = await getReasoningBank();
    const result = {
 ...
 */
export async function handlePostCommand(input, context) {
    const reasoningBank = await getReasoningBank();
    const recordedAt = new Date().toISOString();
    // Create and store trajectory for learning
 ...
 */
export async function handleRoute(input, context) {
    const reasoningBank = await getReasoningBank();
 ...
 */
export async function handleExplain(input, context) {
    const reasoningBank = await getReasoningBank();
 ...
 */
export async function handlePretrain(input, context) {
    const reasoningBank = await getReasoningBank();
 ...
 */
export async function handleMetrics(input, context) {
    const reasoningBank = await getReasoningBank();
 ...
 */
export async function handleListHooks(input, context) {
    const reasoningBank = await getReasoningBank();
    const stats = reasoningBank.getStats();
    const hooks = [
        {
