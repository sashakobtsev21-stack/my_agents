 ...
 * Create a new task
 */
export async function handleCreateTask(input, context) {
 ...
 */
export async function handleListTasks(input, context) {
    // Try to use orchestrator if available
    if (context?.orchestrator) {
        try {
            const orchestrator = context.orchestrator;
 ...
 * Get task status
 */
export async function handleTaskStatus(input, context) {
    // Try to use orchestrator if available
    if (context?.orchestrator) {
        try {
            const orchestrator = context.orchestrator;
 ...
 * Cancel a task
 */
export async function handleCancelTask(input, context) {
 ...
 */
export async function handleAssignTask(input, context) {
 ...
 */
export async function handleUpdateTask(input, context) {
 ...
 */
export async function handleTaskDependencies(input, context) {
    const updatedAt = new Date().toISOString();
    // Try to use orchestrator if available
    if (context?.orchestrator) {
        try {
 ...
 * Get task results
 */
export async function handleTaskResults(input, context) {
    // Try to use orchestrator if available
    if (context?.orchestrator) {
        try {
            const orchestrator = context.orchestrator;
