 ...
 */
export function generateSimpleEmbedding(text: string, dim: number = 768): Float32Array {
 ...
 */
export function inferAgentFromTask(task: string): { agent: string; confidence: number } {
