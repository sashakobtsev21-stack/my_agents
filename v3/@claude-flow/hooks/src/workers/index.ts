...
// Shared fs/scan/security helpers + size/recursion/concurrency limits
// moved to ./fs-helpers.ts (W85, P3.7 cut #2).
import {
  MAX_CONCURRENCY,
  MAX_ALERTS,
  MAX_HISTORY,
...
// ============================================================================
// Type definitions + WORKER_CONFIGS moved to ./types.ts (W84, P3.7 cut
// #1). Re-exported so external importers keep working; imported by name
// for inline use in the WorkerManager class + worker factories below.
// ============================================================================
...
// Built-in worker factories moved to ./factories.ts (W86, P3.7 cut #3).
// Re-exported (public API) + imported so createWorkerManager registers
// them.
