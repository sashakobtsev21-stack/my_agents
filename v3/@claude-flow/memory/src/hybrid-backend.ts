...
// Types/defaults extracted into ./hybrid-backend-types.ts during
// campaign-2 wave 61 (W267).
export type {
  HybridBackendConfig,
  StructuredQuery,
  SemanticQuery,
  HybridQuery,
} from './hybrid-backend-types.js';
import { DEFAULT_CONFIG } from './hybrid-backend-types.js';
import type {
  HybridBackendConfig,
  HybridQuery,
  SemanticQuery,
