...
// Types/tables/config extracted into ./auto-memory-bridge-defs.ts during
// campaign-2 wave 8 (W214). Re-export the public surface; ParsedEntry,
// ResolvedConfig, the tables and DEFAULT_CONFIG stay module-private.
export type {
  InsightCategory,
  SyncDirection,
  SyncMode,
  ...
  SyncResult,
  ImportResult,
} from './auto-memory-bridge-defs.js';
import {
  CATEGORY_LABELS,
  DEFAULT_CONFIG,
