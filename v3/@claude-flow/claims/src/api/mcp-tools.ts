...
// Zod input schemas moved to ./mcp-tools/schemas.ts (W127, P3.17 cut #1).
import {
  issueClaimSchema,
  issueReleaseSchema,
  issueHandoffSchema,
  issueStatusUpdateSchema,
  issueListAvailableSchema,
  issueListMineSchema,
  issueBoardSchema,
  issueMarkStealableSchema,
  issueStealSchema,
  issueGetStealableSchema,
  issueContestStealSchema,
  agentLoadInfoSchema,
  swarmRebalanceSchema,
  swarmLoadOverviewSchema,
  claimHistorySchema,
  claimMetricsSchema,
  claimConfigSchema,
