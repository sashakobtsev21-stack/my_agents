/**
 * Claims MCP tool definitions — the 17 MCPTool objects (input schema +
 * handler wiring) for issue claim/release/handoff/status, listing/board,
 * steal/contest, agent-load/swarm, and claim history/metrics/config.
 *
 * Extracted from mcp-tools.ts (W130, P3.17 cut #6 — final).
 */
import type { JSONSchema, MCPTool } from './tool-types.js';
import type { Claim, Issue } from './store.js';
import {
