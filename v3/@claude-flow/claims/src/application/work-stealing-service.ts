...
// The service interface + in-memory bus were extracted into
// ./work-stealing-event-bus.ts during campaign-2 wave 46 (W252).
export type { IWorkStealingService } from './work-stealing-event-bus.js';
export { InMemoryWorkStealingEventBus } from './work-stealing-event-bus.js';
import { InMemoryWorkStealingEventBus } from './work-stealing-event-bus.js';
import type { IWorkStealingService } from './work-stealing-event-bus.js';
