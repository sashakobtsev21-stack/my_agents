...
// Types/constants/keyword-table extracted into ./sona-optimizer-defs.ts
// during campaign-2 wave 5 (W211). The lazy contrastive-trainer lets
// stay here with their loader and consumers (TS2540 discipline).
export type {
  TrajectoryOutcome,
  LearnedPattern,
  RoutingSuggestion,
  SONAStats,
} from './sona-optimizer-defs.js';
import {
