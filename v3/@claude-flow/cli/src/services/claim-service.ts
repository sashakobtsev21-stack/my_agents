...
// GitHubSync class moved to ./github-sync.ts (W148, P3.28 cut #2);
// imported for the createGitHubSync factory + re-exported for callers.
import { GitHubSync } from './github-sync.js';
export { GitHubSync } from './github-sync.js';
// Type definitions moved to ./claim-service/types.ts (W147, P3.28 cut #1).
import {
  DEFAULT_CONFIG,
  type Claimant,
  type ClaimStatus,
...
// Re-exported so callers importing these from './claim-service.js' resolve
// byte-identically.
export type {
  Claimant,
  ClaimStatus,
