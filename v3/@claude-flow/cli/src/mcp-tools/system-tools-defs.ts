/**
 * System MCP Tools — tool definitions
 *
 * Extracted verbatim from system-tools.ts (lines 101-719) during
 * campaign-2 wave 75 (W281); module-private group const, spread back by
 * the barrel.
 */
...
import {
  ...
  loadMetrics,
  saveMetrics,
} from './system-tools-store.js';
import type { SystemMetrics } from './system-tools-store.js';

export const systemToolDefs: MCPTool[] = [
  {
    name: 'system_status',
