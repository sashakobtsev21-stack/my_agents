...
import { assessCommandRisk } from './hooks-tools/routing-helpers.js';
...
} from './hooks-tools/memory-search-store.js';
...
import { getSemanticRouter, generateSimpleEmbedding } from './hooks-tools/semantic-router.js';
