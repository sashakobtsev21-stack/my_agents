/**
 * Hive-mind MCP tool definitions — spawn / init / status / join / leave /
 * consensus / broadcast / shutdown / memory / optimize-memory. Each wires
 * the shared state + consensus helpers from ./helpers.js.
 *
 * Extracted from hive-mind-tools.ts (W140, P3.22 cut #2 - final).
 */
...
export const hiveMindSpawn: MCPTool =   {
...
export const hiveMindInit: MCPTool =   {
    name: 'hive-mind_init',
...
export const hiveMindStatus: MCPTool =   {
...
export const hiveMindJoin: MCPTool =   {
    name: 'hive-mind_join',
...
export const hiveMindLeave: MCPTool =   {
...
export const hiveMindConsensus: MCPTool =   {
...
export const hiveMindBroadcast: MCPTool =   {
...
export const hiveMindShutdown: MCPTool =   {
...
export const hiveMindMemory: MCPTool =   {
...
export const hiveMindOptimizeMemory: MCPTool =   {
