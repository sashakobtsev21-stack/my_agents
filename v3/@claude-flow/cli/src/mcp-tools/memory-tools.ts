...
// Shared helpers (validation, key sanitization, glob, project-dir
// resolution, legacy-store migration, lazy init) moved to
// ./memory-tools/helpers.ts (W124, P3.16 cut #1).
import {
  validateMemoryInput,
  sanitizeMemoryKey,
  globToRegex,
  ...
  getMemoryFunctions,
  ensureInitialized,
} from './memory-tools/helpers.js';
// CRUD tools (store/retrieve/search/delete/list) moved to
// ./memory-tools/tools-crud.ts (W125, P3.16 cut #2).
