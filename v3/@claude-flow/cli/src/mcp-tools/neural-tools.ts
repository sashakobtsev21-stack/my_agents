...
// Embedding subsystem + storage helpers moved to ./neural-tools/helpers.ts
// (W137, P3.21 cut #1). realEmbeddings/embeddingServiceName are ESM live
// bindings (the tools read the service name for status).
import {
  realEmbeddings,
  ...
  loadNeuralStore,
  saveNeuralStore,
} from './neural-tools/helpers.js';
import type { NeuralModel, Pattern } from './neural-tools/helpers.js';
