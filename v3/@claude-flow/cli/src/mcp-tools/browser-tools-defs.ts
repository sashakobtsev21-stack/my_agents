/**
 * Browser MCP Tools — tool definitions
 *
 * Extracted verbatim from browser-tools.ts (lines 114-704) during
 * campaign-2 wave 76 (W282); module-private group const, spread back by
 * the barrel.
 */

import type { MCPTool } from './types.js';
import { validateIdentifier, validateText } from './validate-input.js';
import { browserSessions, execBrowserCommand, needsNoSandbox } from './browser-tools-session.js';

export const browserToolDefs: MCPTool[] = [
  // ==========================================================================
  // Navigation Tools
  // ==========================================================================
  {
