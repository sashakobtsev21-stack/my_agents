/**
 * Performance MCP Tools — tool definitions
 *
 * Extracted verbatim from performance-tools.ts (lines 89-729) during
 * campaign-2 wave 74 (W280); module-private group const, spread back by
 * the barrel.
 */
...
export const performanceToolDefs: MCPTool[] = [
  {
