...
// Defs/sampling extracted into ./model-router-defs.ts during campaign-2
// wave 10 (W216). Re-export the original public surface; the bandit
// internals are imported back without re-export.
export {
  MODEL_CAPABILITIES,
  COMPLEXITY_INDICATORS,
} from './model-router-defs.js';
export type {
  ClaudeModel,
  ModelRouterConfig,
  ModelRoutingResult,
