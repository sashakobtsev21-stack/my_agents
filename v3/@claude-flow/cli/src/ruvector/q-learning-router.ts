...
// Defs extracted into ./q-learning-router-defs.ts during campaign-2
// wave 18 (W224). Re-export the public surface; internals stay private.
export type { QLearningRouterConfig, RouteDecision } from './q-learning-router-defs.js';
import {
  DEFAULT_CONFIG,
  ENCODER_VERSION,
  FEATURE_KEYWORDS,
  ROUTE_NAMES,
} from './q-learning-router-defs.js';
import type {
  CacheEntry,
  Experience,
  PersistedModel,
  QEntry,
  QLearningRouterConfig,
  RouteDecision,
} from './q-learning-router-defs.js';
