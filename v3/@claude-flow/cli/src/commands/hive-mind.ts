...
// Spawn infrastructure (worker grouping, topology/consensus catalogues,
// prompt generator, Claude Code spawner) + the worker-shape types moved
// to ./hive-mind/spawn.ts (W116, P3.14 cut #1). The child_process / fs /
