/**
 * Daemon core subcommands — start / stop / status / trigger / enable, plus
 * the relative-time formatters used by the status table.
 *
 * Extracted from daemon.ts (W134, P3.19 cut #2).
 */
