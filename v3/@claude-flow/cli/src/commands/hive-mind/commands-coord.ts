/**
 * Hive-mind coordination subcommands — agent membership + consensus +
 * broadcast + shared-memory ops + graceful shutdown (all via MCP).
 *
 *   - joinCommand · leaveCommand · consensusCommand · broadcastCommand ·
 *     memorySubCommand · shutdownCommand
 *
 * Extracted from hive-mind.ts (W119, P3.14 cut #5 — final).
 */
