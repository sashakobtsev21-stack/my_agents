/**
 * Route Command — agent table, router singleton & the 8 subcommands
 *
 * The AgentType table, the mutable router-singleton lets (kept with all
 * their consumers — TS2540 discipline), and task/list-agents/stats/
 * feedback/reset/export/import/coverage-route. Extracted verbatim from
 * route.ts (lines 23-824) during campaign-2 wave 22 (W228).
 * Module-private group; only the command consts are imported back.
 */
