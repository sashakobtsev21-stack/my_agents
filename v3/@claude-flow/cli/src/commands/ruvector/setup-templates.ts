/**
 * RuVector Setup — docker-compose / init-SQL / README templates
 *
 * Module-private in the original setup.ts (campaign-2 W268); NOT
 * re-exported.
 */

export const DOCKER_COMPOSE_TEMPLATE = `# RuVector PostgreSQL Testing Environment
 ...
 */
export const INIT_SQL_TEMPLATE = `-- ============================================
...
-- ============================================
-- PART 3: HNSW INDICES (~1.9x-4.7x (measured))
-- ============================================
 ...
 * README template
 */
export const README_TEMPLATE = `# RuVector PostgreSQL Setup
