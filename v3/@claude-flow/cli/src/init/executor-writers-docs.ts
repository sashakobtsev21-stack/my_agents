/**
 * Init documentation writers — the generated CAPABILITIES.md overview
 * and the project CLAUDE.md.
 *
 *   - writeCapabilitiesDoc  (.claude-flow/CAPABILITIES.md — the full
 *                           Ruflo feature overview; called by the runtime
 *                           writer)
 *   - writeClaudeMd         (project CLAUDE.md + optional global merge)
 *
 * Extracted from executor.ts (W82, P3.6 cut #6).
 */
