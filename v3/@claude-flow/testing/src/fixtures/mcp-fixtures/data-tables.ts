/**
 * MCP Fixtures — tool/resource/prompt/config/result/error/session tables
 *
 * Extracted verbatim from data.ts (lines 17-615) during campaign-2 wave
 * 90 (W296). data.ts stays the barrel ('export *').
 */

import type {
  MCPTool, MCPToolResult, MCPResource, MCPPrompt, MCPServerConfig,
  MCPError, MCPSessionContext,
} from './types.js';
