...
import type { AgentInstance } from '../fixtures/agent-fixtures.js';
import type { SwarmState, SwarmConfig, SwarmTask } from '../fixtures/swarm-fixtures.js';

/**
 * Event bus interface for DDD events
 */

// The service contracts were extracted into ./mock-factory-types.ts
// during campaign-2 wave 89 (W295). 'export *' keeps the surface
// byte-identical.
export * from './mock-factory-types.js';
import type {
  AgentConfig,
  AgentFilters,
  DomainEvent,
