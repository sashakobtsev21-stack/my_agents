/**
 * Guidance Control Plane — the GuidanceControlPlane facade
 *
 * The orchestrating facade over compiler/retriever/gates/ledger/
 * optimizer/headless/gateway, its DEFAULT_CONFIG, and the factory.
 * Extracted verbatim from index.ts (lines 433-754) during campaign-2
 * wave 92 (W298). index.ts re-exports it, so the package surface is
 * unchanged.
 */
