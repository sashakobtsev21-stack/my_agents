 ...
 *
 * The belief ledger with its private config/serialization constants.
 * Extracted verbatim from uncertainty.ts (lines 169-704) during
 * campaign-2 wave 41 (W247). uncertainty.ts stays the barrel
 * (type-only back-import — W208/W234 shape).
 */
