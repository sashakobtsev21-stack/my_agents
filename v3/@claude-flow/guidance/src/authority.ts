...
// Types/tables extracted into ./authority-defs.ts during campaign-2
// wave 68 (W274).
export type {
  AuthorityLevel,
...
} from './authority-defs.js';
import {
  AUTHORITY_HIERARCHY,
  DEFAULT_AUTHORITY_SCOPES,
  DEFAULT_COSTLY_REVERSIBLE_PATTERNS,
  DEFAULT_IRREVERSIBLE_PATTERNS,
  DEFAULT_REVERSIBLE_PATTERNS,
} from './authority-defs.js';
import type {
  AuthorityCheckResult,
  AuthorityGateConfig,
