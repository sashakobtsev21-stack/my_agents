...
// The mode tables were extracted into ./sona-manager-configs.ts during
// campaign-2 wave 26 (W232).
import { MODE_CONFIGS, MODE_OPTIMIZATIONS } from './sona-manager-configs.js';
