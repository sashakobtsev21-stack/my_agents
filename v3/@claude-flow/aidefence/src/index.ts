 ...
 * - HNSW-indexed threat pattern search (~1.9x-4.7x (measured) with AgentDB)
...
export interface AIDefence {
   ...
   * Achieves ~1.9x-4.7x (measured) speedup when connected to AgentDB
   */
 ...
 *
 * // With AgentDB for HNSW search (~1.9x-4.7x (measured))
