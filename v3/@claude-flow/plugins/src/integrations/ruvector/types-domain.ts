/**
 * RuVector types — domain layer
 *
 * Connection configuration, vector operations, attention mechanisms,
 * GNN layers, and hyperbolic embeddings. Extracted verbatim from types.ts
 * (lines 12-859) during the P3.40 god-file decomposition (W161).
 * types.ts stays the barrel; import from './types.js' as before.
 */
