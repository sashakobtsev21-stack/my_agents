...
// AttentionSQLBuilder was extracted into ./attention-sql-builder.ts
// during campaign-2 wave 87 (W293). 'export *' keeps the surface
// byte-identical.
export * from './attention-sql-builder.js';
