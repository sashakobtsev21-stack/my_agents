/**
 * Attention Mechanisms — sparse & linear family
 *
 * Sparse/BlockSparse/Linear/Performer/Linformer/Reformer. Extracted
 * verbatim from attention-mechanisms.ts (lines 28-465) during
 * campaign-2 wave 86 (W292). attention-mechanisms.ts stays the barrel.
 */
import type {
  AttentionMechanism,
  AttentionConfig,
