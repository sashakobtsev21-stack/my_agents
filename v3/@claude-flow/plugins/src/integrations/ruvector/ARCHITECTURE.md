...
- **Vector Operations**: Similarity search, clustering, quantization (~1.9x-4.7x (measured))
...
| `mha_flash` | Flash Attention v2 | Long sequences (Flash Attention speedup (unverified)) |
