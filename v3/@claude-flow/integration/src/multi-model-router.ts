...
// Type definitions moved to ./multi-model-router-types.ts (W157, P3.36
// cut #1). Imported for the class + re-exported (index.ts re-exports them
// from here, incl. ProviderType as RouterProviderType — byte-identical).
import type {
  CompletionRequest,
  CompletionResponse,
  CostTracker,
  ...
  RoutingResult,
  RoutingRule,
} from './multi-model-router-types.js';
export type {
  ProviderType,
  RoutingMode,
  ModelCapabilities,
