...
// Types + the in-memory storage were extracted into
// ./long-running-worker-types.ts during campaign-2 wave 36 (W242).
export type {
  Checkpoint,
  CheckpointState,
  ...
  ExecutionPhase,
  ProgressUpdate,
} from './long-running-worker-types.js';
import { InMemoryCheckpointStorage } from './long-running-worker-types.js';
import type {
  Checkpoint,
  CheckpointState,
  CheckpointStorage,
