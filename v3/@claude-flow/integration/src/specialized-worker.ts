...
// Types + the embedding table were extracted into
// ./specialized-worker-types.ts during campaign-2 wave 38 (W244).
export type {
  DomainSpecialization,
  SpecializedWorkerConfig,
  DomainHandlers,
  TaskMatchResult,
} from './specialized-worker-types.js';
import { DOMAIN_EMBEDDINGS } from './specialized-worker-types.js';
import type {
  DomainHandlers,
  DomainSpecialization,
  SpecializedWorkerConfig,
