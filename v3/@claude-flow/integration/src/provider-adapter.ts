...
// Type definitions moved to ./provider-adapter-types.ts (W152, P3.31
// cut #1). Imported for the class + re-exported (barrel keeps the public
// API byte-identical; src/index.ts re-exports these from here).
import type {
  Provider,
  ProviderStatus,
  ModelInfo,
