...
// Preset generators moved to ./config-toml.presets.ts (W153, P3.32 cut #1).
// Re-exported so src/index.ts (deep-imports generateMinimal/CI) + any other
// caller of './generators/config-toml.js' resolve them byte-identically.
export {
