export default class GitHubIntegrationView {
    ...
    createGitHubInterface() {
        const tabs = [
            ...
            {
                label: '📁 Repositories',
                content: this.createRepositoriesTab()
            },
            {
                label: '🔄 Pull Requests',
                content: this.createPullRequestsTab()
            },
            {
                label: '📋 Issues',
                content: this.createIssuesTab()
            },
            {
                label: '🚀 Releases',
                content: this.createReleasesTab()
            },
            {
                label: '🤖 Automation',
                content: this.createAutomationTab()
            },
            {
                label: '📊 Analytics',
                content: this.createAnalyticsTab()
            },
            {
                label: '🔍 Code Review',
                content: this.createCodeReviewTab()
            }
        ];
    ...
    async executePRAction() {
        ...
        this.quickAction('github_pr_manage', {
            repo,
            pr_number: prNumber,
            action
        });
    ...
    async trackIssues() {
        const repo = prompt('Enter repository (owner/repo):');
        if (!repo) return;
        this.quickAction('github_issue_track', {
            repo,
            action: 'track'
        });
    }
    ...
    async checkMetrics() {
        const repo = prompt('Enter repository (owner/repo):');
        if (!repo) return;
        this.quickAction('github_metrics', {
            repo
        });
    }
    async fetchMetrics() {
    ...
    async startCodeReview() {
        ...
        if (!repo || !pr) return;
        this.quickAction('github_code_review', {
            repo,
            pr
        });
    }
...
//# sourceMappingURL=GitHubIntegrationView.js.map