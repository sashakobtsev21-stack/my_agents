export default class NeuralNetworkView {
    ...
    createNeuralNetworkInterface() {
        const tabs = [
            ...
            {
                label: '🧠 Training',
                content: this.createTrainingTab()
            },
            {
                label: '🔮 Prediction',
                content: this.createPredictionTab()
            },
            {
                label: '🎯 Patterns',
                content: this.createPatternsTab()
            },
            {
                label: '💾 Models',
                content: this.createModelsTab()
            },
            {
                label: '⚡ Optimization',
...
//# sourceMappingURL=NeuralNetworkView.js.map