let WorkflowAutomationView = class WorkflowAutomationView {
    ...
    createWorkflowInterface() {
        const tabs = [
            ...
            {
                label: '🔄 Workflows',
                content: this.createWorkflowsTab()
            },
            {
                label: '⚡ Automation',
            ...
            {
                label: '🚀 Pipelines',
                content: this.createPipelinesTab()
            },
            {
                label: '📅 Scheduler',
                content: this.createSchedulerTab()
            },
            {
                label: '🎯 SPARC Modes',
                content: this.createSparcModesTab()
            },
            {
                label: '📦 Batch & Parallel',
                content: this.createBatchTab()
            }
        ];
...
//# sourceMappingURL=WorkflowAutomationView.js.map