export class ViewManager {
    ...
    setupDOMContainer() {
        this.containerElement = document.getElementById('claude-flow-ui') || document.createElement('div');
    ...
    async registerView(viewConfig) {
        ...
        this.eventBus.emit('view:registered', {
            viewId: config.id,
            config
        });
    ...
    async loadView(viewId, params = {}) {
        ...
        try {
            this.eventBus.emit('view:loading', {
                viewId,
                params
            });
            ...
            this.eventBus.emit('view:loaded', {
                viewId,
                params
            });
    ...
    async hideCurrentView() {
        ...
        this.eventBus.emit('view:hidden', {
    ...
    async unloadView(viewId) {
        ...
        this.eventBus.emit('view:unloaded', {
            viewId
        });
