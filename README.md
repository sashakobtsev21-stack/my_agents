...
> 🧠 **Новичкам:** [`docs/CONCEPTS.md`](docs/CONCEPTS.md) (или [интерактивный HTML](docs/concepts.html)) — «для чайников»: кто что делает и чем **агент** отличается от **скилла / команды / плагина / MCP-инструмента**, плюс оргструктура (кто кем командует).
