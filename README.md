...
> 📖 **Полный реестр всех агентов** с разделением на **руководителей** (оркестраторы/координаторы) и исполнителей: **[`docs/AGENT-CATALOG.md`](docs/AGENT-CATALOG.md)** — авто-генерируется, сразу видно кого подключать к задаче.
