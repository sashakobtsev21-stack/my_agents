...
- **104 агента** (после архивации 20 «advanced» в `agents-advanced/`) приведены к единому стандарту промпта (триггерный `description`, *When to use*, *Output contract*, *Coordination* с тирами 0/1/2/3, *anti-drift*, `## Model & cost`).
