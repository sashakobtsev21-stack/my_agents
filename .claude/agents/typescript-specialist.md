...
Align type contracts with the `system-architect`'s design (types are the contract that prevents drift); hand the reviewer a summary of public-API type changes; give the tester the typed entry points.
